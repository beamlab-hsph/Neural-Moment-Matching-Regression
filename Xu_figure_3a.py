...
nmmr_1000 = pd.read_csv("/dumps/03-22-18-34-39 NMMR Fig 3 Demand/n_sample:1000/result.csv", header=None, names=['nmmr_1000'])
nmmr_5000 = pd.read_csv("/dumps/03-22-18-34-39 NMMR Fig 3 Demand/n_sample:5000/result.csv", header=None, names=['nmmr_5000'])
