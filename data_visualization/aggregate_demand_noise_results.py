...
boxplot_df.to_csv(op.join(data_for_figs, "demand_noise_boxplot_data.csv"), index=False)
predcurve_df.to_csv(op.join(data_for_figs, "demand_noise_predcurve_data.csv"), index=False)
