...
class DFPV_CNN_Model:
    ...
    def fit_2sls(treatment_1st_feature_1st: torch.Tensor,
        ...
        # stage1
        feature = DFPV_CNN_Model.augment_stage1_feature(treatment_1st_feature_1st,
        ...
        feature = DFPV_CNN_Model.augment_stage1_feature(treatment_1st_feature_2nd,
        ...
        # stage2
        feature = DFPV_CNN_Model.augment_stage2_feature(predicted_outcome_proxy_feature,
    ...
    def predict_t(self, treatment: torch.Tensor):
        ...
        feature = DFPV_CNN_Model.augment_stage2_feature(mean_outcome_proxy_mat,
                                                   treatment_feature,
