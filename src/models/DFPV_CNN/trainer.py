...
from src.models.DFPV_CNN.nn_structure import build_extractor
from src.models.DFPV_CNN.model import DFPV_CNN_Model
...
class DFPV_CNN_Trainer(object):
    ...
    def train(self, train_data: PVTrainDataSet, verbose: int = 0) -> DFPV_CNN_Model:
        ...
        mdl = DFPV_CNN_Model(self.treatment_1st_net, self.treatment_2nd_net, self.treatment_proxy_net,
    ...
    def stage1_update(self, train_1st_t: PVTrainDataSetTorch, verbose: int):
        ...
        for i in range(self.stage1_iter):
            ...
            treatment_1st_feature_1st = self.treatment_1st_net(train_1st_t.treatment.reshape(-1, 1, 64, 64))
            ...
            feature = DFPV_CNN_Model.augment_stage1_feature(treatment_feature=treatment_1st_feature_1st,
    ...
    def stage2_update(self, train_1st_data_t, train_2nd_data_t, verbose):
        ...
        with torch.no_grad():
            treatment_1st_feature_1st = self.treatment_1st_net(train_1st_data_t.treatment.reshape(-1, 1, 64, 64))
            treatment_1st_feature_2nd = self.treatment_1st_net(train_2nd_data_t.treatment.reshape(-1, 1, 64, 64))
        ...
        for i in range(self.stage2_iter):
            ...
            treatment_2nd_feature_2nd = self.treatment_2nd_net(train_2nd_data_t.treatment.reshape(-1, 1, 64, 64))
            backdoor_2nd_feature_2nd = None
            if self.backdoor_2nd_net:
                backdoor_2nd_feature_2nd = self.backdoor_2nd_net(train_2nd_data_t.backdoor)

            res = DFPV_CNN_Model.fit_2sls(treatment_1st_feature_1st,
...
def dfpv_cnn_experiments(data_config: Dict[str, Any], model_param: Dict[str, Any],
    ...
    trainer = DFPV_CNN_Trainer(data_config, model_param, dump_dir)
