...
class Naive_NN_for_dsprite_AWZY(nn.Module):

    def __init__(self, train_params):
        super(Naive_NN_for_dsprite_AWZY, self).__init__()
        self.train_params = train_params
...
class Naive_NN_for_dsprite_AWY(nn.Module):

    def __init__(self, train_params):
        super(Naive_NN_for_dsprite_AWY, self).__init__()
        self.train_params = train_params
        self.batch_size = train_params["batch_size"]
...
class Naive_NN_for_dsprite_AY(nn.Module):

    def __init__(self, train_params):
        super(Naive_NN_for_dsprite_AY, self).__init__()
        self.train_params = train_params
        self.batch_size = train_params["batch_size"]
